package com.strata.firstmyle_lib.singin;
...
import com.strata.firstmyle_lib.signin_otp.Authentication;
...
public class test extends FragmentActivity implements
    ...
    public void onClick(View v) {
        if (!mGoogleApiClient.isConnecting()) {
            ...
            } else if (i == R.id.sign_out_button) {// We clear the default account on sign out so that Google Play
            ...
            } else if (i == R.id.revoke_access_button) {// After we revoke permissions for the user with a GoogleApiClient
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        if (i == R.id.request_auth_code_checkbox) {
        ...
        } else if (i == R.id.has_token_checkbox) {
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        mRevokeButton.setEnabled(true);Person currentPerson = Plus.PeopleApi
...
//        String personGooglePlusProfile = currentPerson.getUrl();
        ...
        LibRestClient.getRouteService().userLogin(email, "", "google", callback);
    }
    ...
    public boolean onUploadServerAuthCode(String idToken, String serverAuthCode) {
        ...
        try {
            ...
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(test.this, responseBody, Toast.LENGTH_LONG).show();
                }
            });
