 ...
 */
public class BlogFeedDetailView extends DetailView {

    private View rootView;

    public BlogFeedDetailView (Context context,FeedPost sPost, ActionClickListener listener){
...
//            ImageView icon_comment = (ImageView)rootView.findViewById(R.id.comment);
            ...
            title.setText(blogFeed.getTitle());
