 ...
 */
public class BctcDetailView extends DetailView {

    private View rootView;

    public BctcDetailView (Context context,FeedPost sPost, ActionClickListener listener){
