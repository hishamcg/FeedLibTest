 ...
 */
public class MessageView extends ChatView {
    ...
    public MessageView(Context context, Reply reply, ChatView.ChatClickListener l, String publisher_id) {
    ...
    public void initialize() {
        ...
        View rowView = inflater.inflate(R.layout.chat_list_item_message, null);
        ...
        int ml = msg.length();
        final SpannableStringBuilder sb = new SpannableStringBuilder(msg + "aaaaaa");
        sb.setSpan(fcs, ml, ml + 6, Spannable.SPAN_INCLUSIVE_INCLUSIVE);
        holder.Lmessage.setText(sb);
