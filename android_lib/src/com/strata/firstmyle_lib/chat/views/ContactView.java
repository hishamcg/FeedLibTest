...
public class ContactView extends ChatView {
    ...
    public ContactView(Context context, Reply reply, ChatClickListener l, String publisher_id) {
    ...
    public void initialize() {
        ...
        View rowView = inflater.inflate(R.layout.chat_list_item_contact, null);
        TextView name = (TextView) rowView.findViewById(R.id.name);
        //for now just showing the number
        name.setText(reply.getPublisher().getName()+" has been added");
