 ...
 */
public class BlogFeed extends FeedItemInflater {
    @Override
    public View inflate(LayoutInflater inflater,Activity activity,FeedLib temp_feed,InflaterInitializer initializer){
        ...
        View rowView = inflater.inflate(R.layout.listview_item_featured_content, null);
        ...
        text.setText(temp_feed.getPost_header().getDetail()!=null?temp_feed.getPost_header().getDetail():"");
